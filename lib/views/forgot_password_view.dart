...
import 'package:flutterappdev/utilities/dailogs/password_reset_email_sent_dialog.dart';
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              const Text(
                'if you have forgotten your password simply enter your email and we will send you a password',
              ),
              TextField(
